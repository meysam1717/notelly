<div class="w-full max-w-3xl p-4 ">
    <div role="list" class="grid grid-cols-1 mb-3 gap-x-3 gap-y-4 lg:grid-cols-2">
        @foreach($notes as $note)
            <div class="px-4 py-5 rounded-md bg-card sm:px-6" wire:ignore>
                <div class="flex space-x-3">
                    ...
                    <div class="flex self-center flex-shrink-0">
                        <div class="relative inline-block text-left">
                            <div>
                                <button onclick="deleteFolder({{ $note->folder_id }},{{ $note->id }},'{{ $note->title }}')"
...
@push('js')
    <script type="text/javascript">
        ...
        function deleteFolder(folderId,noteId, noteTitle) {
